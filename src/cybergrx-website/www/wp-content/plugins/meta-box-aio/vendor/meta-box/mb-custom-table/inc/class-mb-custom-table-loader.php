...
class MB_Custom_Table_Loader {
	 ...
	 * Replaced the built-in maybe_serialize() function in WordPress since it does double-serialize
	 * if the data is already serialized.
	 *
	 * @param string|array $data Data that might be serialized.
