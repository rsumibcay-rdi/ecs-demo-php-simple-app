...
if ( ! function_exists( 'mb_custom_table_load' ) ) {
	require dirname( __FILE__ ) . '/inc/class-mb-custom-table-api.php';
	require dirname( __FILE__ ) . '/inc/class-mb-custom-table-cache.php';
	...
	function mb_custom_table_load() {
		...
		require dirname( __FILE__ ) . '/inc/class-mb-custom-table-loader.php';
		require dirname( __FILE__ ) . '/inc/class-rwmb-table-storage.php';
